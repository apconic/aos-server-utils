...
export function get(path: string, role?: string | string[], isSecure: boolean = true) {
...
export function post(path: string, role?: string | string[], isSecure: boolean = true) {
  return function(target: any, propertyKey: string, descriptor: PropertyDescriptor) {
    const name = Object.create(target).constructor.name;
...
export function del(path: string, role?: string | string[], isSecure: boolean = true) {
  return function(target: any, propertyKey: string, descriptor: PropertyDescriptor) {
    const name = Object.create(target).constructor.name;
