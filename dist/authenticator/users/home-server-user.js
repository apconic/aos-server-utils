...
var _preferredUsername, _businessUnits, _transporterCode, _userType, _currentBusinessUnit, _roles;
...
class HomeServerUser {
    ...
    checkRole(roleName) {
        if (!__classPrivateFieldGet(this, _roles).find((r) => r.name === roleName)) {
...
_preferredUsername = new WeakMap(), _businessUnits = new WeakMap(), _transporterCode = new WeakMap(), _userType = new WeakMap(), _currentBusinessUnit = new WeakMap(), _roles = new WeakMap();
