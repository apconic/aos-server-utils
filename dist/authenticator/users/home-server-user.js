...
class HomeServerUser {
    ...
    toPlainObject() {
        return {
            username: __classPrivateFieldGet(this, _HomeServerUser_preferredUsername, "f"),
            userType: __classPrivateFieldGet(this, _HomeServerUser_userType, "f"),
            currentBU: __classPrivateFieldGet(this, _HomeServerUser_currentBusinessUnit, "f"),
            transporterCode: __classPrivateFieldGet(this, _HomeServerUser_transporterCode, "f"),
        };
    }
}
